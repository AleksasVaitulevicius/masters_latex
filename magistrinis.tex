...
\raktiniaizodziai{Klasifikavimo uždavinys, 3D objektai, dirbtiniai neuroniniai tinklai, CapsNet neuroniniai tinklai, Konvoliuciniai neuroniniai tinklai}   
...
\section{3D objektų atpažinimo iš 2D nuotraukų uždavinys}
\input{3d.object.recognition.task.tex}

\section{CapsNet dirbtinių neuroninių tinklų apžvalga ir kalibracija}
\input{capsnet.tex}

\section{Konvoliucinių dirbtinių neuroninių tinklų apžvalga}
\input{cnn.tex}

\section{CapsNet ir konvoliucinių neuroninių tinklų eksperimentiniai tyrimai}
