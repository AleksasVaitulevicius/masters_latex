...
\raktiniaizodziai{Klasifikavimo uždavinys, 3D objektai, dirbtiniai neuroniniai tinklai, kapsuliniai neuroniniai tinklai, Konvoliuciniai neuroniniai tinklai}   
...
\section{3D objektų atpažinimo iš 2D nuotraukų uždavinys, jo sprendinių pavyzdžiai}
\input{3d.object.recognition.task.tex}

\section{Konvoliucinių dirbtinių neuroninių tinklų apžvalga}
\input{cnn.tex}

\section{Kapsulinių dirbtinių neuroninių tinklų apžvalga ir kalibracija}
\input{capsnet.tex}

\section{Kapsulinių ir konvoliucinių neuroninių tinklų eksperimentiniai tyrimai}
